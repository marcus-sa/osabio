...
i see the tools were copied, but nothing of the old code was removed?

### Prompt 7

we copied a bunch of files to tools/

### Prompt 8

but how are our existing agents using the tools now?
