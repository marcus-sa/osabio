...
learning node has not been implemented yet . see see gh issue Agent learnings: persistent behavioral modifications with cross-agent suggestions #44

### Prompt 4

ok, so we should implement learnings first ?
...
nodes have to be added to graph ui as well
