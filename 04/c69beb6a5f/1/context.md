...
the entity detail panel is pushing the graph container to the side. it should "overlay"

### Prompt 25

workspace doesnt show now

### Prompt 26

entity detail panel for workspace doesnt show now in graph
