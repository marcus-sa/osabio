...
import { type TestUser, collectSseEvents, createTestUser, fetchJson, setupAcceptanceSuite } from "../acceptance-test-kit";
...
const getRuntime = setupAcceptanceSuite("priority");
