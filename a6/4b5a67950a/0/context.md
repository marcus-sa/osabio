...
the diagrams in @docs/design/task-status-ownership/architecture.md are broken

### Prompt 15

renders as: ""👤 Developer<br/><i>Commits code locally</i>"

### Prompt 16

the architecture and roadmap doesnt mention anything regarding extracting the logic from github webhook commit processor for the llm analyzier

### Prompt 17

no, it should all just happen on the server.
