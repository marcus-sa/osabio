...
run the architecture reviewer next

### Prompt 6

"The next step would be to address the 3 high issues in the design docs" cant we just add this to the plan
...
add test info to tests/AGENTS.md so we can avoid wasting time on this in the future
