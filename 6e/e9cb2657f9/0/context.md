...
update AGENTS.md to instruct that acceptance tests must be run after every nw:deliver step phase

### Prompt 3

it doesnt have to run all, only the affected ones, or the new ones related to the feature
