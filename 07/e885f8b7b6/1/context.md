...
embeddings have been removed ?? why are they suddenly required?

### Prompt 15

FIX THE FUCKING FAILING TEST AND THE IMPLEMENTATION SO THAT IT WORKS WITH OPENCLAW!!!

"4 CLI smoke tests fail because openclaw binary isn’t available locally — these will pass in CI or when the package is installed"

What the fuck are u talking about? stop making fucking assumption u piece of shit. the openclaw binary is excuted via "bunx openclaw"
...
STOP FUCKING REPEATING URSELF. ADD BACK THE FUCKING DEBUG LOGS
...
REMOVE THE FUCKING EMBEDDING ENV VARS

### Prompt 20

but are the openclaw tests passing?
